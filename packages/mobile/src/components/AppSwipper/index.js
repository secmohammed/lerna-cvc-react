...
import handleInitState from './initState';
import {
  Text,
  View,
  ScrollView,
...
export default class Swipper extends Component {
  ...
  initState(props, updateIndex = false) {
    const initState = handleInitState(this.state, props, updateIndex);
    this.internals = {
      ...this.internals,
      isScrolling: false
    };
  ...
  renderPagination = () => {
    ...
    const ActiveDot = this.props.activeDot || (
      <View style={[styles.activeDoStyle, this.props.activeDotStyle]} />
    );

    const Dot = this.props.dot || (
      <View style={[styles.dotStyle, this.props.dotStyle]} />
    );
